          ...
          {filteredRecipes && filteredRecipes.map((
            recipe) => (
              ...
              <Col
                ...
                <RecipeCard name={recipe.recipeName} id={recipe.idrecipe} instructions={recipe.recipeInstruction} img={recipe.imgURL} ingredients={recipe.ingredients} numLikes={recipe.totalLikes}
