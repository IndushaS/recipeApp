...
const Recommendations = () => {
  ...
  async function fetchData() {
    const res = await fetch(
      "https://recipe342backend.herokuapp.com/getRecommendations?id=3"
    );
    res
      .json()
  ...
  async function getUserid() {
    const result = await fetch(
      "https://recipe342backend.herokuapp.com/getUserid?email=indusha999@gmail.com"
    );
    result
      .json()
